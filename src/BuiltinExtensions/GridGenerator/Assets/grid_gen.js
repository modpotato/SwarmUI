    ...
    register() {
        ...
        this.settingsDiv.innerHTML =
            ...
            <div class="hoverable-minor-hint-text">
                ...
                &emsp;You can prefix any value with "<code>SKIP:</code>" (in all caps) to automatically skip that value (but keep it listed in the grid).&emsp;<a href="https://github.com/modpotato/SwarmUI/blob/master/src/BuiltinExtensions/GridGenerator/README.md" target="_blank">Full README/docs here</a>
            </div>`;
