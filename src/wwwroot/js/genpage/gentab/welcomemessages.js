...
function automaticWelcomeMessage(override = null) {
    ...
    let messages = [
        ...
        `Did you know:\nWant to try some fancy prompting?\nJust type a '&lt;' symbol and watch the suggestions for prompt-syntax tools appear! Give the syntax features a try! <a target="_blank" href="https://github.com/modpotato/SwarmUI/blob/master/docs/Features/Prompt%20Syntax.md">(Documentation Here)</a>`,
        ...
        `Release notes (2025-08-25): Check out the <a target="_blank" href="https://github.com/modpotato/SwarmUI/releases/tag/0.9.7-Beta">Release Notes for version 0.9.7 (Beta)</a>`
    ];
