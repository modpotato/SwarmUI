...
public static class UserUpstreamApiKeys
{
    ...
    static UserUpstreamApiKeys()
    {
        ...
        Register(new("openrouter_api", "openrouter", "OpenRouter", "https://openrouter.ai/keys", new("To use the LLM-based prompt refinement feature in SwarmUI, you must set your OpenRouter API key.\n<br>This will allow you to refine prompts using various LLM models. Access this feature via the '+' button next to the prompt box.")));
    }
}
