...
Step 2 is copy/paste the error message and search [GitHub](https://github.com/modpotato/SwarmUI/issues) and [Discord](https://discord.gg/q2y38cqjNw). Chances are you'll find somebody else has posted the same error message before and gotten an answer explaining what to do.
